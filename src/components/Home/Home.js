...
const Home = ()=>{
  return (
    ...
    <Stack direction={["column", "row"]} spacing={["16"]} alignItems={['ceter', 'center']}  justifyContent={["center", "space-around"]} >
      <VStack alignItems={["center", "flex-end"]} padding={["20px","20px"]} justifyContent={["center","center"]}>
        ...
        <Text className="text">Learn Industry Ready Skills At Most Resonable price</Text>
        <Link to="/courses">
